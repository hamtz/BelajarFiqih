...
public class Quis_Fiqih1 extends AppCompatActivity {
    ...
    private class LoadQuestionsTask extends AsyncTask<String, Integer, Void> {
        ...
        private void displayQuestion(final int questionID) {
            ...
            final ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                    Quis_Fiqih1.this, R.layout.quiz_answer_row, questions
                    ...
                    .setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(final AdapterView<?> parent,
                            ...
                            if (currentQuestion <= questions.size() - 1) {
                                ...
                                final Intent i = new Intent(Quis_Fiqih1.this,
